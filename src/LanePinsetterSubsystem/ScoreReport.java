...
import LanePinsetterSubsystem.Score;
import LanePinsetterSubsystem.ScoreHistoryFile;
...
public class ScoreReport {
	...
	public ScoreReport(Bowler bowler, int[] scores, int games ) {
		...
		content = "";
		content += "--Lucky Strike Bowling Alley LanePinsetterSubsystem.Score Report--\n";
		content += "\n";
	...
	public void sendEmail(String recipient) {
		try {
			...
			sendln(in, out, "DATA");
			sendln(out, "Subject: Bowling LanePinsetterSubsystem.Score Report ");
